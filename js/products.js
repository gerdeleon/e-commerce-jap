...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function setProductID(id){
    localStorage.setItem("setProductID", id);
...
function setCatID(id) {
  ...
  function filterEvents() {
    document.getElementById("sortAsc").addEventListener("click", function () {
        sortAndShowCategories(ORDER_ASC_BY_PRICE, currentCategoriesArray);
    });

    document.getElementById("sortDesc").addEventListener("click", function () {
        sortAndShowCategories(ORDER_DESC_BY_PRICE, currentCategoriesArray);
    });

    document.getElementById("sortBySoldCount").addEventListener("click", function () {
        sortAndShowCategories(ORDER_DESC_BY_SOLD_COUNT, currentCategoriesArray);
    });
  }